...
FFMPEG_CONFIG_FLAGS_BASE=(
  ...
  --enable-encoder=pcm*,mp3*,opus,libopus,vorbis,libvorbis,wavpack,adpcm_ima_wav,flac,aac*,libfdk_aac
  --enable-decoder=pcm*,mp3*,opus,libopus,vorbis,libvorbis,wavpack,adpcm_ima_wav,flac,aac*,libfdk_aac \
